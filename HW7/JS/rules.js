...
$(document).ready(function () {
    //Custom method for testing Minimun versus Maximum
    ...
    //Custom method for testing for non decimal value
    ...
    $("#RangeForm").validate({
        ...
        //Customize error placement and styling
        errorPlacement: function (error, element) {
            if (element.attr("name") == "Minimum_CV") {

                error.addClass("col-md-12 text-danger text-center")
    ...
    //Trigger final validation and prevent submit if error exists
